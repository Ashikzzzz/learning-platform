    ...
    <Carousel>
      <Carousel.Item className="caroselPic">
        ...
        <Carousel.Caption>
          ...
          <p className="text-dark">
            ...
            doing them.” ― Aristotle. “Learning is not attained by chance, it
            must be sought for with ardor and attended to with diligence.” ―
            Abigail Adams. “The beautiful thing about learning is that nobody
      ...
      <Carousel.Item className="caroselPic">
        ...
        <Carousel.Caption>
          ...
          <p className="text-light">
            ...
            An expert is a man who knows just that much more about his subject
            than his associates. Most of us are nearer the top than we think. We
            fail to realize how easy it is, how necessary it is to learn that
            fraction more.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item className="caroselPic">
        ...
        <Carousel.Caption>
          ...
          <p className="text-light">
            Summary. Continuous learning is important because it helps people to
            feel happier and more fulfilled in their lives and careers, and to
